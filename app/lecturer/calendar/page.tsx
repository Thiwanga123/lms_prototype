...
import { AlertCircle, Clock, CheckCircle, FileText, Users, BookOpen, TrendingUp } from 'lucide-react';
...
interface CalendarItem {
  ...
  date: Date;
  title: string;
  type: 'grading' | 'assignment' | 'course' | 'deadline';
  course: string;
  dueDate: Date;
  ...
  return (
    <div className="space-y-4 lg:space-y-6 xl:space-y-8">
      <div>
        ...
        <p className="text-sm lg:text-base text-gray-600">Track your grading deadlines, course schedules, and tasks</p>
      </div>
                ...
                >
                  ...
                  {item.submissions !== undefined && (
                    <div className="flex items-center gap-1 text-xs text-gray-600 mb-1">
                      ...
                      <span>{item.submissions} submissions pending</span>
                    </div>
                  )}
      ...
      {overdueItems.length > 0 && (
        <div className="bg-white/80 backdrop-blur-sm rounded-lg lg:rounded-xl p-4 lg:p-5 xl:p-6 shadow-lg border-2 border-red-200">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg lg:text-xl font-bold text-red-800">Overdue Tasks</h2>
          </div>
          <div className="space-y-3">
              ...
              >
                ...
                {item.submissions !== undefined && (
                  <div className="flex items-center gap-1 text-sm text-gray-600 mb-1">
                    ...
                    <span>{item.submissions} submissions need grading</span>
                  </div>
                )}
      ...
      {upcomingItems.length > 0 && (
        <div className="bg-white/80 backdrop-blur-sm rounded-lg lg:rounded-xl p-4 lg:p-5 xl:p-6 shadow-lg border border-purple-200/50">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg lg:text-xl font-bold text-gray-800">Upcoming Tasks</h2>
          </div>
          <div className="space-y-3">
...
export default LecturerCalendarPage;
