...
const sidebarItems: SidebarItem[] = [
  { name: 'Dashboard', href: '/student/dashboard', icon: <LayoutDashboard className="w-4 h-4" /> },
  { name: 'My Courses', href: '/student/courses', icon: <BookOpen className="w-4 h-4" /> },
  { name: 'Assignments', href: '/student/assignments', icon: <FileText className="w-4 h-4" /> },
  { name: 'Quizzes', href: '/student/quizzes', icon: <HelpCircle className="w-4 h-4" /> },
  { name: 'Calendar', href: '/student/calendar', icon: <Calendar className="w-4 h-4" /> },
  { name: 'Grades', href: '/student/grades', icon: <Award className="w-4 h-4" /> },
