...
const sidebarItems: SidebarItem[] = [
  ...
  { name: 'Courses', href: '/dashboard/courses', icon: <BookOpen className="w-4 h-4" /> },
  { name: 'Students', href: '/dashboard/students', icon: <Users className="w-4 h-4" /> },
  { name: 'Lecturers', href: '/dashboard/lecturers', icon: <GraduationCap className="w-4 h-4" /> },
  { name: 'Calendar', href: '/dashboard/calendar', icon: <Calendar className="w-4 h-4" /> },
  { name: 'Assignments', href: '/dashboard/assignments', icon: <FileText className="w-4 h-4" /> },
  { name: 'Grades', href: '/dashboard/grades', icon: <TrendingUp className="w-4 h-4" /> },
  { name: 'Announcements', href: '/dashboard/announcements', icon: <Megaphone className="w-4 h-4" /> },
